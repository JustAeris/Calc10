...
namespace WPFModernUITest
{
    ...
    public partial class Converter : UserControl
    {
        ...
        private readonly string[] AngleList = { "Graden", "Radialen", "Rangen" };
        private readonly string[] DataList = { "Bits", "Octet", "Kilobit", "Kilo-octet / Kilobyte", "Megabit", "Megaoctet / Megabyte", "Gigabit", "Gigaoctet / Gigabyte", "Terabit", "Teraoctet / Terabyte", "Petabit", "Petaoctet / Petabyte", "Exabit", "Exaoctet / Exabyte", "Zettabit", "Zettaoctet / Zettabyte", "Yottabit", "Yottaoctet / Yottabyte", };
        private readonly string[] EnergyList = { "Joule", "Kilojoule", "Voedingscalorie (Kcal)" };
        private readonly string[] TimeList = { "Microseconde", "Milliseconde", "Seconde", "Minuut", "Uur", "Dag", "Week", "Maand", "Jaar" };
        private readonly string[] LengthList = { "Nanometer", "Micrometer", "Millimeter", "Centimeter", "Meter", "Kilometer", "Inches", "Voet", "Yard", "Mijl" };
        private readonly string[] PowerList = { "Watt", "Kilowatt" };
        private readonly string[] PressureList = { "Atmosfeer", "Bar", "Pascal" };
        private readonly string[] SpeedList = { "Centimeter per Seconde", "Meter per Seconde", "Kilometer per Uur", "Mijl per Uur", "Mach" };
        private readonly string[] SurfaceList = { "Vierkante Millimeter", "Vierkante Centimeter", "Vierkante Meter", "Hectare", "Vierkante Kilometer", "Vierkante Inch", "Vierkante Voet", "Vierkante Yard", "Vierkante Mijl", };
        private readonly string[] TemperatureList = { "Celsuis", "Fahrenheit", "Kelvin" };
        private readonly string[] VolumeList = { "Milliliter", "Kubieke Centimeter", "Liter", "Kubieke Meter", "Gallon", "Kubieke Inch", "Kubieke Voet" };
        private readonly string[] WeightList = { "Milligram", "Centigram", "Decigram", "Gram", "Decagram", "Hectogram", "Kilogram", "Ton", "Ons", "Pond", "Ton (VS)" };
