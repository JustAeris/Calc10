...
namespace WPFModernUITest
{
    ...
    public partial class Converter : UserControl
    {
        ...
        private readonly string[] AngleList = { "Degrés", "Radians", "Grades" };
        ...
        private readonly string[] EnergyList = { "Joule", "Kilojoule", "Calorie Alimentaire (Kcal)" };
        private readonly string[] TimeList = { "Microseconde", "Milliseconde", "Seconde", "Minute", "Heure", "Jour", "Semaine", "Mois", "Année" };
        private readonly string[] LengthList = { "Nanomètre", "Micromètre", "Millimètre", "Centimètre", "Mètre", "Kilomètre", "Pouce", "Pied", "Yard", "Mile" };
        private readonly string[] PowerList = { "Watt", "Kilowatt" };
        private readonly string[] PressureList = { "Atmosphère", "Bar", "Pascal" };
        private readonly string[] SpeedList = { "Centimètre par Seconde", "Mètre par Seconde", "Kilomètre par Heure", "Mile par Heure", "Mach" };
        private readonly string[] SurfaceList = { "Millimètre Carré", "Centimètre Carré", "Mètre Carré", "Hectare", "Kilomètre Carré", "Pouce Carré", "Pied Carré", "Yard Carré", "Mile Carré", };
        private readonly string[] TemperatureList = { "Celsuis", "Fahrenheit", "Kelvin" };
        private readonly string[] VolumeList = { "Millilitre", "Centimètre Cube", "Litre", "Mètre Cube", "Gallon", "Pouce Cube", "Pied Cube" };
        private readonly string[] WeightList = { "Milligramme", "Centigramme", "Décigramme", "Gramme", "Décagramme", "Hectogramme", "Kilogramme", "Tonne", "Once", "Livre", "Tonne (US)" };
