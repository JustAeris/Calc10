...
namespace WPFModernUITest
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void NavigationView_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
        {
            ...
            if (SelectedIndex == 1)
            {
                CustomHeader.Text = " Kalkulator";
            }

            if (SelectedIndex == 2)
            {
                CustomHeader.Text = " Konwerter";
            }

            if (SelectedIndex == 3)
            {
                CustomHeader.Text = " Waluty";
            }

            if (SelectedIndex == 4)
            {
                CustomHeader.Text = " Naukowy";
            }

            if (SelectedIndex == 5)
            {
                CustomHeader.Text = " Tryb programisty";
            }

            if (SelectedIndex == 6)
            {
                CustomHeader.Text = " Obliczanie dat";
            }

            if (SelectedIndex == 7)
            {
                CustomHeader.Text = " Ustawienia";
            }
