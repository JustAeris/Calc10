    ...
    public partial class Date : UserControl
    {
        ...
        private void fromDate_SelectedDateChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (fromDate.SelectedDate != null && toDate.SelectedDate != null)
            {
                ...
                {
                    diffDate.Text = ts + " Dni";
                }
                else
                {
                    diffDate.Text = removeUselessNumbers(day, week, month, year) + " Lub " + ts + " Dni w ogóle";
                }
            }
        }
        ...
        private string removeUselessNumbers(int day, int week, int month, int year)
        {
            ...
            if (week == 1)
            {
                weekStr = week + " Tydzień";
            }
            else if (week != 0)
            {
                weekStr = week + " Tygodnie";
            }

            if (month == 1)
            {
                monthStr = month + " Miesiąc";
            }
            else if (month != 0)
            {
                monthStr = month + " Miesiące";
            }
