...
namespace WPFModernUITest
{
    ...
    public partial class Converter : UserControl
    {
        ...
        private readonly string[] AngleList = { "Degrees", "Radians", "Grades" };
        private readonly string[] DataList = { "Bits", "Octet", "Kilobit", "Kilo-octet / Kilobyte", "Megabit", "Megaoctet / Megabyte", "Gigabit", "Gigaoctet / Gigabyte",
        ...
        private readonly string[] EnergyList = { "Joule", "Kilojoule", "Food Calorie (Kcal)" };
        private readonly string[] TimeList = { "Microsecond", "Millisecond", "Second", "Minute", "Hour", "Day", "Week", "Month", "Year" };
        private readonly string[] LengthList = { "Nanometre", "Micrometre", "Millimetre", "Centimetre", "Metre", "Kilometre", "Inches", "Foot", "Yard", "Mile" };
        private readonly string[] PowerList = { "Watt", "Kilowatt" };
        private readonly string[] PressureList = { "Atmosphere", "Bar", "Pascal" };
        private readonly string[] SpeedList = { "Centimetre per Second", "Metre per Second", "Kilometre per Hour", "Miles per Hour", "Mach" };
        private readonly string[] SurfaceList = { "Square Millimetre", "Square Centimetre", "Square Metre", "Hectare", "Square Kilometre", "Square Inch", "Square Foot", "Square Yard", "Square Mile", };
        private readonly string[] TemperatureList = { "Celsuis", "Fahrenheit", "Kelvin" };
        private readonly string[] VolumeList = { "Millilitre", "Cubic Centimetre", "Litre", "Cubic Metre", "Gallon", "Cubic Inch", "Cubic Foot" };
        private readonly string[] WeightList = { "Milligram", "Centigram", "Decigram", "Gram", "Decagram", "Hectogram", "Kilogram", "Tonne", "Ounce", "Pound", "Ton (US)" };
